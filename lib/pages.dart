...
List<Page> _buildPage() {
  final List<Page> _pageList = <Page>[
    ...
    Page(
        title: 'Scaffold',
        subhead:
            'Material Design布局结构的基本实现此类提供了用于显示drawer、snackbar和底部sheet的API',
        icon: null,
        category: _kBasics,
    ...
    Page(
        title: 'TabBarView',
        subhead: '显示与当前选中的选项卡相对应的页面视图通常和TabBar一起使用',
        icon: null,
        category: _kMDComponents,
    ...
    Page(
        title: 'Card',
        subhead: '一个 Material Design 卡片拥有一个圆角和阴影',
        icon: null,
        category: _kMDComponents,
    ...
    Page(
        ...
        subhead: 'iOS风格的分段控件用于在水平列表中选择互斥选项',
        icon: null,
        category: _kCupertino,
    ...
    Page(
        ...
        subhead: 'iOS风格的选择器控件用于选择短列表中的项目',
        icon: null,
        category: _kCupertino,
    ...
    Page(
        title: 'SizedBox',
        subhead: '一个特定大小的盒子如宽高为NULL，则此盒子大小匹配到子部件的大小',
        icon: null,
        category: _kLayout,
    ...
    Page(
        title: 'Theme',
        subhead: '将主题应用于子部件主题描述了应用选择的颜色和字体',
        icon: null,
        category: _kStyling,
    ...
    Page(
        title: 'Semantics',
        subhead: '用于描述部件树的具体语义使用辅助工具、搜索引擎和其他语义分析软件来确定应用程序的含义',
        icon: null,
        category: _kAccess,
    ...
    Page(
        ...
        icon: null,
        category: _kExpandList,
        routeName: DragItemDemo.routeName,
        buildRoute: (BuildContext context) => DragItemDemo()),
    Page(
        title: '能量球',
        subhead: '一个能量球',
        icon: null,
        category: _kExpandList,
        routeName: PowerCircleDemo.routeName,
        buildRoute: (BuildContext context) => PowerCircleDemo()),
    Page(
        title: '飘雪',
        subhead: '飘雪特效',
        icon: null,
        category: _kExpandList,
        routeName: FallingWidgetDemo.routeName,
        buildRoute: (BuildContext context) => FallingWidgetDemo()),
    ///design
    Page(
        title: '聊天室',
